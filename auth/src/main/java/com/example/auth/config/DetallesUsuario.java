...
/**
 * Implementación personalizada de UserDetails para integrar la información del
 * usuario en el contexto de seguridad de Spring Security.
 *
 * Esta clase adapta un objeto {@link UsuarioResponse} al contrato que Spring
 * Security necesita para autenticar y autorizar usuarios.
 *
 * Nota: Actualmente, el método {@code getAuthorities()} devuelve null, por lo
 * que no se manejan roles o permisos explícitos.
 *
 * @author Ramos
 */
public class DetallesUsuario implements UserDetails {
     ...
     * @param encoder Codificador de contraseñas (no utilizado en este
     * constructor, pero puede ser útil para futuras modificaciones).
     */
     ...
     *
     * @return colección de GrantedAuthority, actualmente null porque nunca se
     * ocupó.
     */
    @Override
